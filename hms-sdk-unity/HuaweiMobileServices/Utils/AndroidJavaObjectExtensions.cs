...
namespace HuaweiMobileServices.Utils
{
	...
	{
		private static readonly AndroidJavaClass ArraysClass = new AndroidJavaClass("java.util.Arrays");
		...
		public static T[] AsArray<T>(this AndroidJavaObject javaObject) where T : JavaObjectWrapper
		{
			...
			var list = ArraysClass.CallStatic<AndroidJavaObject>("asList", javaObject).AsListFromWrappable<T>();
